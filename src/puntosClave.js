...
const estaAleteando = (guiState) => {
    ...
    let condicionDer = (cuerpo.codoDer.x - cuerpo.hombroDer.x <= guiState.rangoDeteccionBrazosBajos && cuerpo.codoDer.x - cuerpo.hombroDer.x >= 0)
    ...
    if (porcentajeDer < guiState.porcentajeDeteccionDeAleteo) {
        return true
    } else {
        return false
    }
